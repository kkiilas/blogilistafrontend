...
describe('<Blog />', () => {
  ...
  beforeEach(() => {
    ...
    const blog = {
      title: 'This Supreme Court May Be an Abomination. But It Is Not an Aberration.',
  ...
  test('at the start, title and author are displayed  while url and likes are not displayed', () => {
    expect(screen.getByText('This Supreme Court May Be an Abomination. But It Is Not an Aberration. Jamelle Bouie')).toBeVisible()
    expect(screen.getByText('https://www.nytimes.com/2022/02/11/opinion/supreme-court-alabama-maps.html')).not.toBeVisible()
  ...
  test('displays url and likes as well after clicking the view button', () => {
    ...
    expect(screen.getByText('https://www.nytimes.com/2022/02/11/opinion/supreme-court-alabama-maps.html')).toBeVisible()
